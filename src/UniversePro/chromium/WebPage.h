...
namespace Browser
{
	...
	class CChromeBookmarkTabDelegate : public CChromeBookmarkTabHelperDelegate
	{
	public:
		CChromeBookmarkTabDelegate();
		~CChromeBookmarkTabDelegate()override;

		void OnNTPCreated(HWND hWebPage)override;
	};
	...
	public:
		...
		CChromeBookmarkTabDelegate* m_pBookmarkTabDelegate;
