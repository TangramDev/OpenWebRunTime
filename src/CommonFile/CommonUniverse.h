...
class CWebRTImpl {
 public:
  ...
  virtual CChromeBookmarkTabHelperDelegate* CreateBookmarkTabHelperDelegate(
      CChromeBookmarkTabHelper*) {
    return nullptr;
  }
...
class CChromeBookmarkTabHelper {
 public:
  ...
  virtual ~CChromeBookmarkTabHelper() {}
  bool m_bNTPCreated;
  HWND m_hWebPage;
  CChromeBookmarkTabHelperDelegate* m_pDelegate;
};

class CChromeBookmarkTabHelperDelegate {
 public:
  CChromeBookmarkTabHelperDelegate() {
    m_pHost = nullptr;
    m_bNTPCreated = false;
    m_pRenderFrameHost = nullptr;
  }
  virtual ~CChromeBookmarkTabHelperDelegate() {}
  bool m_bNTPCreated;
  CChromeBookmarkTabHelper* m_pHost;
  CChromeRenderFrameHost* m_pRenderFrameHost;

  virtual void OnNTPCreated(HWND hWebPage) {}
};
